...
:: USER PATH
:: %~dp0 = C:\users\[user]\Desota\Portables\TinyPython\executables\Windows
...
set req_uninstall_path=%model_execs_basepath%\tinypython.uninstall.bat
...
:allinone
IF %quiet_bool% EQU 0 GOTO noisy_uninstall
